...
namespace ProyectoFinalAplicada2.Controllers
{
    public class EventosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descripcion,Fecha")] Evento evento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descripcion,Fecha")] Evento evento)
        {
            if (id != evento.Id)
            {
                return NotFound();
